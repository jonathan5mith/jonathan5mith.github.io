    ...
    <div class="cards twoinrow">
      ...
      <div class="border-below">
        <table>
          <tr>
            <td id="tablefix">
              <img src="https://dl.dropboxusercontent.com/u/10455351/Assets/blank.png"\><p id="vesttag">
            </td>
            <td>
              London
            </td>
...
queryVests.first({
  ...
  success: function(object) {
            ...
            if(vests[0]==true){
              document.getElementById("vest1").innerHTML = '<img src="https://dl.dropboxusercontent.com/u/10455351/Assets/vest1.png">'
            }
            else{
              document.getElementById("vest1").innerHTML = '<img src="https://dl.dropboxusercontent.com/u/10455351/Assets/blank.png">'
            };
            

            if(vests[1]==true){
              document.getElementById("vest2").innerHTML = '<img src="https://dl.dropboxusercontent.com/u/10455351/Assets/vest2.png">'
            }
            else{
              document.getElementById("vest2").innerHTML = '<img src="https://dl.dropboxusercontent.com/u/10455351/Assets/blank.png">'
            }

            if(vests[2]==true){
              document.getElementById("vest3").innerHTML = '<img src="https://dl.dropboxusercontent.com/u/10455351/Assets/vest3.png">'
            }
            else{
              document.getElementById("vest3").innerHTML = '<img src="https://dl.dropboxusercontent.com/u/10455351/Assets/blank.png">'
            }

            if(vests[3]==true){
              document.getElementById("vest4").innerHTML = '<img src="https://dl.dropboxusercontent.com/u/10455351/Assets/vest4.png">'
            }
            else{
              document.getElementById("vest4").innerHTML = '<img src="https://dl.dropboxusercontent.com/u/10455351/Assets/blank.png">'
            }

            if(vests[4]==true){
              document.getElementById("vest5").innerHTML = '<img src="https://dl.dropboxusercontent.com/u/10455351/Assets/vest5.png">'
            }
            else{
              document.getElementById("vest5").innerHTML = '<img src="https://dl.dropboxusercontent.com/u/10455351/Assets/blank.png">'
            }
            
            if(vests[5]==true){
              document.getElementById("vest6").innerHTML = '<img src="https://dl.dropboxusercontent.com/u/10455351/Assets/vest6.png">'
            }
            else{
              document.getElementById("vest6").innerHTML = '<img src="https://dl.dropboxusercontent.com/u/10455351/Assets/blank.png">'
            }
